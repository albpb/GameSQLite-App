...
import 'package:reactive_todo_app/bloc/game_bloc.dart';
import 'package:reactive_todo_app/model/games.dart';
import 'package:reactive_todo_app/dao/employee_api_provider.dart';
...
class HomePage extends StatelessWidget {
  ...
  final GameBloc todoBloc = GameBloc();
  final String title;
  final GameApiProvider apiProvider = GameApiProvider();
  ...
  void _showAddTodoSheet(BuildContext context) {
    ...
    final _gamePlatformFormController = TextEditingController();
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: const InputDecoration(
                                  hintText: 'Mi juego pendiente es...',
                                  labelText: 'Título',
                          ...
                          Expanded(
                            child: TextFormField(
                              controller: _gamePlatformFormController,
                              textInputAction: TextInputAction.newline,
                              maxLines: 4,
                              style: TextStyle(
                                  fontSize: 21, fontWeight: FontWeight.w400),
                              autofocus: true,
                              decoration: const InputDecoration(
                                  hintText: 'La consola de mi juego es...',
                                ...
                                onPressed: () {
                                  final newTodo = Game(
                                      title: _todoDescriptionFormController
                                          .value.text,
                                      platform: _gamePlatformFormController
                                          .value.text);
  ...
  Widget getTodoCardWidget(AsyncSnapshot<List<Game>> snapshot) {
      ...
      return snapshot.data.length != 0
          ? ListView.builder(
              ...
              itemBuilder: (context, itemPosition) {
                Game todo = snapshot.data[itemPosition];
          ...
          : Container(
              ...
              //in the data base
              child: noTodoMessageWidget(snapshot),
            ));
    } else {
      return Center(
  ...
  Widget noTodoMessageWidget(AsyncSnapshot<List<Game>> snapshot) {
    return Container(
      child: Text(
